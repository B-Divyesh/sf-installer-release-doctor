...
Checked August 28, 2026. Counts treat hyphenated terms as one word. No sentence exceeds 22 words. No banned word appears.
...
| The policy pack adds company controls. | 6 | pass |
...
|---|---|
| Built release file | artifact |
| Distribution destination | channel |
| Declarative configuration | manifest |
| Blocking diagnostic | blocker |
| Suggested correction | repair |
| Paid add-on | policy pack |
