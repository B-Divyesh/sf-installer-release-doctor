...
export const sampleReport: DemoReport = {
  product: 'Acme CLI', release: '1.4.0', findings: [
    ...
    { channel: 'winget', check: 'signature', level: 'pass', message: 'Ed25519 signature matches the artifact.' },
    { channel: 'winget', check: 'SBOM', level: 'pass', message: 'CycloneDX SBOM matches the artifact.' },
