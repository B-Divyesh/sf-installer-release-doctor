...
const [version, repository, directory, commit] = process.argv.slice(2);
...
writeFileSync(join(directory, 'latest.json'), JSON.stringify({version, commit: commit || null, assets}, null, 2) + '\n');
